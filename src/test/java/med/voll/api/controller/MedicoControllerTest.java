...
class MedicoControllerTest {
    ...
    void cadastrar_cenario2() throws Exception {
        ...
        var endereco = new DadosEndereco("Rua Tal", "Bairro Tal", "12345678", "Sao Paulo", "SP", null, null);
        var dadosCadastro = new DadosCadastroMedico("Medico", "medico@voll.med", "61999999999", "123456", Especialidade.CARDIOLOGIA, endereco);
